...
io.on("connection",function(socket)
  {   
    socket.on("enregistrer",function(sockName,callback) {
    ...
    // reception de ticket par socket (ticket envoyé par curl par kerawen mais possibilité par socket - à modifier pour intégrer url_longue)
